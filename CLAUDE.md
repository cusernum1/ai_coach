...
- After EVERY response, append one line to the Obsidian log: `/Users/danilavoloshin/Code/ai_coach/Diploma/AI Coach — Обзор проекта.md` → section `## Лог сессий`, format: `- **YYYY-MM-DD:** <what was done>`
- At the START of every session (first user message), silently read `/Users/danilavoloshin/Code/ai_coach/Diploma/AI Coach — Обзор проекта.md` to restore context before answering
